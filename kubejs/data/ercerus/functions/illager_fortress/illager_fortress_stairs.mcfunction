...
#repeat until done
execute at @e[tag=if_setup,limit=1,sort=nearest] at @e[tag=fortress_stairs,limit=1,sort=nearest] run tp @e[tag=fortress_stairs,limit=1,sort=nearest] ~ ~-1 ~-1
execute at @e[tag=if_setup,limit=1,sort=nearest] at @e[tag=fortress_stairs_height,limit=1,sort=nearest] run tp @e[tag=fortress_stairs_height,limit=1,sort=nearest] ~ ~ ~-1
execute at @e[tag=if_setup,limit=1,sort=nearest] at @e[tag=fortress_stairs,limit=1,sort=nearest] unless entity @e[tag=fortress_stairs_height,distance=..1] run schedule function ercerus:illager_fortress/illager_fortress_stairs 2t
execute at @e[tag=if_setup,limit=1,sort=nearest] at @e[tag=fortress_stairs,limit=1,sort=nearest] if entity @e[tag=fortress_stairs_height,distance=..1] run tag @e[tag=fortress_stairs_height,limit=1,sort=nearest] add delete
execute at @e[tag=if_setup,limit=1,sort=nearest] at @e[tag=fortress_stairs_height,limit=1,sort=nearest] if entity @e[tag=fortress_stairs,distance=..1] run tag @e[tag=fortress_stairs,limit=1,sort=nearest] add delete
execute at @e[tag=if_setup,limit=1,sort=nearest] at @e[tag=fortress_stairs_height,limit=1,sort=nearest] positioned ~ 0 ~ if entity @e[tag=fortress_stairs,distance=..62] run tag @e[tag=fortress_stairs,limit=1,sort=nearest] add delete
execute at @e[tag=if_setup,limit=1,sort=nearest] at @e[tag=fortress_stairs_height,limit=1,sort=nearest] positioned ~ 0 ~ if entity @e[tag=fortress_stairs,distance=..62] run tag @e[tag=fortress_stairs_height,limit=1,sort=nearest] add delete
